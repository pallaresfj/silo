...
interface DriveSyncGateway
{
    ...
    /**
     * @return array{changes: list<array{fileId: string, removed: bool, file: array{id: string, name: string, mimeType: string, parents: list<string>, trashed: bool, webViewLink: string|null}|null}>, newStartPageToken: string|null}
     */
    public function allChangesSince(string $startPageToken, ?string $driveId = null): array;

    /**
     * @return list<array{id: string, name: string, mimeType: string, parents: list<string>, trashed: bool, webViewLink: string|null, path: string}>
     */
